...
class DTLSClientSocketImpl : public SSLClientSocket,
 ...
 public:
  ...
  // settings.
  DTLSClientSocketImpl(std::unique_ptr<net::UDPStreamSocket> nested_socket,
                      const HostPortPair& host_and_port,
                      const SSLConfig& ssl_config,
                      const SSLClientSocketContext& context);
  ~DTLSClientSocketImpl() override;
 ...
 private:
  ...
  std::unique_ptr<net::UDPStreamSocket> stream_socket_;
  ...
  base::WeakPtrFactory<DTLSClientSocketImpl> weak_factory_;

  DISALLOW_COPY_AND_ASSIGN(DTLSClientSocketImpl);
};
